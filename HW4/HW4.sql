...
FROM movie_rentals.actor a
JOIN movie_rentals.film_actor fa ON a.actor_id = fa.actor_id
JOIN movie_rentals.film f ON fa.film_id = f.film_id
JOIN movie_rentals.language l ON f.language_id = l.language_id
